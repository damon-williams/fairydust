...
async def get_model_pricing(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to load pricing configuration: {str(e)}")
...
async def update_model_pricing(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to update pricing configuration: {str(e)}")
